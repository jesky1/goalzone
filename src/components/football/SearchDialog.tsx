  ...
  return (
    <>
      ...
      <motion.button
        ...
        aria-label="Search"
      >
        <Search className="w-5 h-5 text-gray-400 dark:text-gray-400 group-hover:text-neon transition-colors" />
        <span className="absolute -top-1 -right-1 w-5 h-5 rounded-md bg-neon/10 border border-neon/20 flex items-center justify-center">
          <kbd className="text-[9px] font-bold text-neon">/</kbd>
        </span>
      </motion.button>
